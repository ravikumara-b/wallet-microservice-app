...
//    ObjectMapper objectMapper;
    ...
    public void walletCreate(String message) throws Exception {
    	...
    	System.out.println("-------------------------------------------------------");
    	System.out.println("walletcreate executing");
        JSONObject jsonObject = (JSONObject) new JSONParser().parse(message);//json string to json object

        System.out.println("read data from kafka is :"+message);
        ...
        System.out.println("id storing:"+userId);
